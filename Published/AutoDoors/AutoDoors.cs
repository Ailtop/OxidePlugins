...
namespace Oxide.Plugins
{
    ...
    public class AutoDoors : RustPlugin
    {
        ...
        private void OnDoorOpened(Door door, BasePlayer player)
        {
            ...
            var autoCloseTime = GetAutoCloseTime(playerData, door);
        ...
        private StoredData.PlayerData defaultData;

        private StoredData.PlayerData DefaultData => defaultData ?? (defaultData = CreateDefaultData());
        ...
        private StoredData.PlayerData CreateDefaultData()
        {
            return new StoredData.PlayerData
            {
        ...
        private static Door GetDoorLookingAt(BasePlayer player)
        {
            RaycastHit rHit;
        ...
        private float GetAutoCloseTime(StoredData.PlayerData playerData, Door door)
        {
            ...
            return playerData.doorData.time;
        }
        ...
        private void CmdAutoDoor(BasePlayer player, string command, string[] args)
        {
            ...
            switch (args[0].ToLower())
            {
                ...
                case "single":
                    {
                        var door = GetDoorLookingAt(player);
